<?php
/**
 * Luminova Framework String List implementation.
 *
 * @package Luminova Utils
 * @author Ujah Chigozie Peter
 * @copyright (c) Nanoblock Technology Ltd
 * @license See LICENSE file
 * @see https://luminova.ng
 */
namespace Peterujah\Strings;
...
class Lists
{
    ...
    private static function parseValue(string $value): mixed 
    {
        ...
        if (substr_count($value, '=') > 1) {
            throw new RuntimeException(sprintf('Invalid list definition, cannot contain multiple equals for: "%s"', $value));
        }
